...
class InfobloxException(exceptions.Backend):
    """Base IB Exception.
    ...
    def __init__(self, **kwargs):
        try:
            super(InfobloxException, self).__init__(self.message % kwargs)
            ...
            if self.use_fatal_exceptions():
                ...
                super(InfobloxException, self).__init__(self.message)
...
class ServiceUnavailable(InfobloxException):
...
class InfobloxException(InfobloxException):
...
class InfobloxIsMisconfigured(InfobloxException):
...
class InfobloxObjectParsingError(InfobloxException):
